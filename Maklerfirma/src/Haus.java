...
public class Haus {
    ...
    public Haus(int preis, int quadratmeter, String beschreibung, String titel){
    ...
    public Haus(int preis, int quadratmeter, String beschreibung, String titel, String[] reservierung){
        setBeschreibung(beschreibung);
        setPreis(preis);
        setQuadratmeter(quadratmeter);
        setTitel(titel);
